...
const quiz = [
    ...
    {
        question: "Q. Which keyword is used to declare a variable that cannot be reassigned in JavaScript?",
    ...
    {
        question: "Q. Which of the following is used to check if a property exists in an object?",
        choices: ["in", "exists", "has", "contains"],
        answer: "in"
    },
    {
        question: "Q. Which method is used to remove whitespace from both ends of a string in JavaScript?",
